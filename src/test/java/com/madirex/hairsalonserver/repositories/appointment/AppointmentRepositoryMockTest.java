package com.madirex.hairsalonserver.repositories.appointment;
...
public class AppointmentRepositoryMockTest {
    ...
    void findById() {
        ...
        Assertions.assertEquals(appointmentRepository.findById(appointment1.getId()).orElse(null), appointment1);
