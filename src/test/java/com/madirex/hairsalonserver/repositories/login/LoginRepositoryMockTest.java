...
public class LoginRepositoryMockTest {
    ...
    void findById() {
        ...
        assertAll(
                () -> Assertions.assertEquals(login, res),
                () -> Assertions.assertEquals(login.getId(), res.getId()),
                () -> Assertions.assertEquals(login.getUser().getUsername(), res.getUser().getUsername()),
                () -> Assertions.assertEquals(login.getInstant(), res.getInstant()),
                () -> Assertions.assertEquals(login.getToken(), res.getToken())
        );
