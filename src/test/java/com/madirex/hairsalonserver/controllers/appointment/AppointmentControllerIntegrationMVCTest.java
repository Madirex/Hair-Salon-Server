package com.madirex.hairsalonserver.controllers.appointment;
...
public class AppointmentControllerIntegrationMVCTest {
    ...
    void findAllTest() throws Exception {
        ...
        assertAll(
                ...
                () -> Assertions.assertEquals(myObjects.get(0).getUser().getUsername(), appointment.getUser().getUsername()),
                () -> Assertions.assertEquals(myObjects.get(0).getService().getName(), appointment.getService().getName())
        );
    }
    ...
    void findByIdTest() throws Exception {
        ...
        assertAll(
                ...
                () -> Assertions.assertEquals(res.getUser().getUsername(), appointment.getUser().getUsername()),
                () -> Assertions.assertEquals(res.getService().getName(), appointment.getService().getName())
        );
    }
